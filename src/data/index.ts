...
export const BLOG_POSTS = [
  { id: 1, title: 'How to Build an ATS-Friendly Resume in 2025', category: 'Resume Tips', author: 'Priya Sharma', date: 'Feb 18, 2025', readTime: '5 min', image: '📝', excerpt: 'Modern recruiters use ATS to filter thousands of resumes. Here is how to make yours stand out with the right keywords, formatting, and structure.' },
  { id: 2, title: 'Top 10 Skills Employers Look for in 2025', category: 'Career Advice', author: 'Rahul Mehta', date: 'Feb 15, 2025', readTime: '7 min', image: '🚀', excerpt: 'The job market is evolving rapidly. From AI literacy to emotional intelligence — discover the skills that make candidates irresistible in 2025.' },
  { id: 3, title: 'How to Ace Behavioral Interviews with the STAR Method', category: 'Interview Tips', author: 'Ananya Singh', date: 'Feb 12, 2025', readTime: '6 min', image: '🎯', excerpt: 'The STAR method (Situation, Task, Action, Result) is your secret weapon for answering tough behavioral interview questions confidently.' },
  { id: 4, title: 'Remote Work in 2025: Opportunities and Challenges', category: 'Industry Trends', author: 'Vikram Nair', date: 'Feb 10, 2025', readTime: '8 min', image: '🌐', excerpt: 'Remote work has reshaped the global job market. Explore the latest trends, top remote-friendly industries, and how to position yourself.' },
  { id: 5, title: 'Salary Negotiation: How to Get What You Deserve', category: 'Career Advice', author: 'Divya Kapoor', date: 'Feb 8, 2025', readTime: '6 min', image: '💰', excerpt: 'Negotiating salary is one of the most valuable career skills — yet most professionals leave money on the table. Here is a proven framework.' },
  { id: 6, title: 'LinkedIn Profile Tips That Attract Recruiters', category: 'Job Search', author: 'Arjun Tiwari', date: 'Feb 5, 2025', readTime: '5 min', image: '🔗', excerpt: 'Your LinkedIn profile is your digital resume. Optimize it with these expert-backed tips to get noticed by top recruiters in your industry.' },
];
